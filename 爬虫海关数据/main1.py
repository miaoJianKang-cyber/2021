...
def getHTMLText(data, cookiestr):
    ...
    while num < 5:
        ...
        url2 = 'https://www.52wmb.com/async/company?key={}&old_key={}&country=&country_id=0&type=0&sort' \
               ...
               '=1604476115171&page={}'.format(data['key'], data['key'], num)
        url1 = 'https://www.52wmb.com/async/company?key={}&old_key={' \
               ...
               '&fw%5B%5D=email&filterweight=email&_=1603852119428&page={} '.format(data['key'], data['key'], num)
        url = 'https://www.52wmb.com/async/company?key={}&old_key={' \
              ...
              '%5B%5D=email&filterweight=email&_=1603434620022&page={}'.format(data['key'], data['key'], num)
        url3 = 'https://www.52wmb.com/async/company?country=*&key={}&type=0&click_search=1&sort=default&country_data=&search_type=3&is_label=1&st=3&page={}&_=1614564485810'.format(
            data['key'], num)
