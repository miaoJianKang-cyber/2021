                ...
                if (element_meta.get_attribute('name') == 'keywords'):
                    ...
                    if ("Ltd" in element_data):
                        ...
                        for i in range(len(late_data) - 2):
                            ...
                            with open('data2.txt', 'a', newline="") as filecsv:
...
def main():
    ...
    while page_current != page_max:
        ...
        print('*' * 100)
        new_url = 'https://xqkj.en.alibaba.com/productlist-{}.html'.format(page_current)
        print(new_url)
...
if __name__ == '__main__':
    ...
    driver.get('https://xqkj.en.alibaba.com/productlist-1.html')
    main()
